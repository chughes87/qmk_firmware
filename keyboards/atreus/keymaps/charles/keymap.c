...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QW] = LAYOUT( /* Qwerty */
         ...
         KC_LALT,KC_TAB, KC_MINS,   LGUI_T(KC_ESC), KC_LSHIFT, MO(_RS), MO(_RS),  KC_SPC, LCTL_T(KC_BSPC), KC_QUOT, KC_ENT, MO(_LW)),
  ...
  [_RS] = LAYOUT( /* [> RAISE <] */
        ...
        KC_LALT, KC_TAB, s(KC_MINS),   LGUI_T(KC_ESC), KC_LSHIFT, MO(_RS), MO(_RS),  KC_SPC, KC_DEL, KC_GRAVE, KC_ENT, MO(_LW)),
